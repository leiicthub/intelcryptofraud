        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground text-center mb-12">
              At Fraudcryptointel, we are dedicated to protecting individuals and businesses from financial fraud and cybercrime. Our team of expert investigators combines cutting-edge technology with decades of experience to recover stolen assets and bring criminals to justice.
            </p>
          </div>
        </div>
      </section>
